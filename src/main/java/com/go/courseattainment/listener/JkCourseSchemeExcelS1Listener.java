 ...
 **/
public class JkCourseSchemeExcelS1Listener extends AnalysisEventListener<JkCourseSchemeExcelS1Vo> {


    private static final int BATCH_COUNT = 5;
    private static final Logger LOGGER = LoggerFactory.getLogger(StudentExcelListener.class);
    List<JkCourseSchemeExcelS1Vo> courseVoList = new ArrayList<>();


    private CourseSchemeService courseSchemeService;
    private Integer majorId;
    public JkCourseSchemeExcelS1Listener(CourseSchemeService courseSchemeService, Integer majorId){
    ...
    @Override
    public void invoke(JkCourseSchemeExcelS1Vo courseSchemeVo, AnalysisContext analysisContext) {
    ...
    public void saveData(){
        ...
        courseSchemeService.saveJkCourseSchemesS1(courseVoList,majorId);
